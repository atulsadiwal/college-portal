...
/>
  ...
  {Array.isArray(filteredData) && filteredData.length > 0 ? (
    filteredData.map((Accomo) => (
      <tr key={Accomo.id} className="border-t">
        <td className="px-4 py-2">{Accomo.name}</td>
        <td className="px-4 py-2">{Accomo.type}</td>
        <td className="px-4 py-2">{Accomo.address}</td>
        <td className="px-4 py-2">{Accomo.city}</td>
        <td className="px-4 py-2">{Accomo.country}</td>
        <td className="px-4 py-2">{Accomo.pincode}</td>
        <td className="px-4 py-2">{Accomo.price}</td>
        <td className="px-4 py-2">{Accomo.phone}</td>
        <td className="px-4 py-2">{Accomo.email}</td>
